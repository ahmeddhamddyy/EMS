    ...
    <div className="space-y-8 animate-in fade-in duration-700 text-right p-4" dir="rtl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard 
          ...
          onClick={() => navigate("/admin-dashboard/search-soldier?filter=ضابط")} 
        />
        <StatCard 
          ...
          color="border-[#1a2e2a]" 
          onClick={() => navigate("/admin-dashboard/search-soldier?filter=صف")}
        />
        <StatCard 
          title="إجمالي الجنود" 
          ...
          onClick={() => navigate("/admin-dashboard/search-soldier?filter=جندي")}
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-orange-50 p-6 rounded-3xl border-r-8 border-orange-600 flex justify-between items-center transition-all hover:bg-orange-100">
          <div>
